      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 p-4 sm:p-6 space-y-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-xl font-bold text-white">Community Safety Intelligence</h1>
              <p className="text-xs text-slate-400">Anonymized safety observations & hazard reporting</p>
            </div>
          </div>
            ...
            <div className="lg:col-span-7 space-y-4">
              <div className="p-4 rounded-2xl glass-panel border border-slate-800 flex items-center justify-between">
                ...
                <select
                  ...
                  className="px-2.5 py-1 rounded-lg bg-slate-900 border border-slate-700 text-xs text-slate-300 focus:outline-none focus:border-indigo-500"
                >
