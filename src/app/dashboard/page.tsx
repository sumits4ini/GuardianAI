...
import { Play, Sparkles, Navigation, SlidersHorizontal, ShieldCheck } from "lucide-react";
      ...
      <div className="flex-1 flex max-w-7xl w-full mx-auto">
        ...
        <main className="flex-1 p-4 sm:p-6 space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            {/* Left Column (5 Cols): Risk Score, Active Journey / CTA, Risk Factors, SOS Button */}
