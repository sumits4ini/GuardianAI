...
export function Sidebar() {
  ...
  return (
    <aside className="w-60 h-[calc(100vh-4rem)] sticky top-16 border-r border-slate-200 dark:border-slate-800 bg-white/70 dark:bg-slate-950/60 p-4 hidden lg:flex flex-col justify-between transition-colors">
      ...
      <div className="space-y-3">
        {user && (
          <div className="p-3 rounded-xl bg-slate-50 dark:bg-slate-900/80 border border-slate-200 dark:border-slate-800 flex items-center justify-between shadow-sm">
            ...
            <button
              ...
              className="p-1.5 rounded-lg text-slate-400 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-slate-200 dark:hover:bg-slate-800 transition-colors flex-shrink-0"
              title="Sign Out"
              aria-label="Sign Out"
            >
        ...
        <div className="p-3.5 rounded-xl bg-indigo-50/80 dark:bg-indigo-950/40 border border-indigo-200 dark:border-indigo-500/20 space-y-1 text-center">
