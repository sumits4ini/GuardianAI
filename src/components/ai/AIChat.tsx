...
const QUICK_SAFETY_SCENARIOS = [
  ...
  "I don't feel safe.",
  "This area feels unsafe.",
  "My friend hasn't reached home.",
  "I am lost.",
      ...
      if (res.ok) {
        ...
        const aiMsg: DistressChatMessage = {
          ...
          analysis: data.shouldShowSOSPrompt ? {
            riskLevel: data.riskLevel === "CRITICAL" ? "CRITICAL" : "HIGH",
            urgency: data.riskLevel === "CRITICAL" ? "IMMEDIATE" : "HIGH",
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-3">
        ...
        <div className="space-y-1.5">
          ...
          <div className="flex flex-wrap gap-1.5">
            {QUICK_SAFETY_SCENARIOS.map((q, idx) => (
              <button
                key={idx}
                ...
                <div className="mt-2 pt-2 border-t border-slate-200 dark:border-slate-800 space-y-2">
                  ...
                  {msg.analysis.shouldTriggerSOSPrompt && (
                    <button
                      ...
                      className="w-full py-2.5 rounded-lg bg-rose-600 hover:bg-rose-500 text-white font-bold text-xs flex items-center justify-center gap-1.5 mt-1 shadow-md shadow-rose-600/30 animate-pulse"
                    >
